...
class EncodingTab(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        table_frame = tk.LabelFrame(self, text=" Tabel Konversi Karakter ", fg="#55FF55", bg="#1e1e1e",
        ...
        wave_frame = tk.LabelFrame(self, text=" Bentuk Gelombang (Line Coding) ", fg="cyan", bg="#1e1e1e",
                                    font=self.font_label)
    ...
    def build_frames(self, text, parity_mode):
        ...
        for ch in text:
            ...
            bits.extend(int(b) for b in bin7)
...
class MainApp:
    def __init__(self, root):
        ...
        notebook.add(tab2, text="  Encoding Digital + Parity  ")
